...
responsible for enforcement through a **private channel**: GitHub → the repository's *Security* tab → **“Report a
vulnerability”**, or a maintainer's direct message (see the repository *About*). Do not use a public issue for
CoC reports. All complaints will be reviewed and investigated promptly and fairly.
